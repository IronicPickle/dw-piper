...
class TkResizer:
  ...
  def __init__(self, frame, on_resize):
    self.resizer_top_frame = Frame(frame, bg="#212121", height=10)
    self.resizer_top_frame.pack(side=TOP, fill=X)
    self.resizer_right_frame = Frame(frame, bg="#212121", width=10)
    self.resizer_right_frame.pack(side=RIGHT, fill=Y)
    self.resizer_bottom_frame = Frame(frame, bg="#212121", height=10)
    self.resizer_bottom_frame.pack(side=BOTTOM, fill=X)
    self.resizer_left_frame = Frame(frame, bg="#212121", width=10)
